...
public class DictionaryRu implements Dictionary {
    ...
    private void addValues() {
        ...
        dictionary.put(GREETING_FOR_START, """
            ...
            🔸 Вызови команду /show_group чтобы посмотреть с кем ты ведешь один список.
            🔸 Вызови команду /change_language для смены языка.
        ...
        dictionary.put(EMPTY_GROUP_MESSAGE, """
            Вы еще не объединились ни с кем в группу. Вызовите команду /join, чтобы узнать, как это сделать.
            """
        );

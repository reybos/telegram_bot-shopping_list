...
import static rey.bos.telegram.bot.shopping.list.bot.handler.impl.callback.CallBackCommand.LEAVE_GROUP_AND_JOIN;

@Slf4j
@Component
public class LeaveGroupAndJoinHandler extends BotHandlerDecision {

    public LeaveGroupAndJoinHandler(MessageUtil messageUtil) {
        super(LEAVE_GROUP_AND_JOIN, messageUtil);
    }

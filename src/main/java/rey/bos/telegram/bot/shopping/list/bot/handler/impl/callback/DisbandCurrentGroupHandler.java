...
import static rey.bos.telegram.bot.shopping.list.bot.handler.impl.callback.CallBackCommand.DISBAND_CURRENT_GROUP;

@Slf4j
@Component
@RequiredArgsConstructor
public class DisbandCurrentGroupHandler extends BotHandler {
    ...
    public boolean support(Update update) {
        return supportCallbackCommand(update, DISBAND_CURRENT_GROUP);
    }
